...
{
    public class ContainerInventoryManager : IInventoryManager
    {
        ...
        public void SetContainer(ContainerItemProvider provider)
        {
            _provider = provider;
            Rebuild();
            Resize(provider.Config.Widht, provider.Config.Height);
        }
