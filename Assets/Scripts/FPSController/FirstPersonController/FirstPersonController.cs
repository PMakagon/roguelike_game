        ...
        #region Variables
            #region Private Serialized     
                ...
                #region Locomotion
                    ...
                    [MinMaxSlider(0f,1f)][SerializeField] private float moveBackwardsSpeedPercent = 0.5f;
                    [MinMaxSlider(0f,1f)][SerializeField] private float moveSideSpeedPercent = 0.75f;
                #endregion

                #region Run Settings
                    [Space, Header("Run Settings")]
                    [MinMaxSlider(-1f,1f)][SerializeField] private float canRunThreshold = 0.8f;
                ...
                #region Crouch Settings
                    ...
                    [MinMaxSlider(0.2f,0.9f)][SerializeField] private float crouchPercent = 0.6f;
                ...
                #region Landing Settings
                    ...
                    [MinMaxSlider(0.05f,0.5f)][SerializeField] private float lowLandAmount = 0.1f;
                    [MinMaxSlider(0.2f,0.9f)][SerializeField] private float highLandAmount = 0.6f;
                ...
                #region Gravity
                    ...
                    [MinMaxSlider(0f,1f)][SerializeField] private float rayLength = 0.1f;
                    [MinMaxSlider(0.01f,1f)][SerializeField] private float raySphereRadius = 0.1f;
                #endregion

                #region Wall Settings
                    [Space, Header("Check Wall Settings")]
                    [SerializeField] private LayerMask obstacleLayers = ~0;
                    [MinMaxSlider(0f,1f)][SerializeField] private float rayObstacleLength = 0.1f;
                    [MinMaxSlider(0.01f,1f)][SerializeField] private float rayObstacleSphereRadius = 0.1f;
            ...
            #region Private Non-Serialized
                #region Components / Custom Classes / Caches
                    ...
                    private CameraController.CameraController m_cameraController;
        ...
        #region Custom Methods
            #region Initialize Methods    
                protected virtual void GetComponents()
                {
                    ...
                    m_cameraController = GetComponentInChildren<CameraController.CameraController>();
