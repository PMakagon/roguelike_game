...
namespace LiftGame.Inventory.Core
{
    ...
    public static class InventoryItemExtensions
    {
        ...
        /// </summary>
        public static Vector2Int GetMinPoint(this IInventoryItem item)
        {
        ...
        /// within its inventory
        /// </summary>
        public static Vector2Int GetMaxPoint(this IInventoryItem item)
        {
        ...
        /// </summary>
        public static bool Contains(this IInventoryItem item, Vector2Int inventoryPoint)
        {
        ...
        /// </summary>
        public static bool Overlaps(this IInventoryItem item, IInventoryItem otherItem)
        {
            for (var iX = 0; iX < item.width; iX++)
            {
                for (var iY = 0; iY < item.height; iY++)
