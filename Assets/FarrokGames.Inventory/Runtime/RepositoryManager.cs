...
namespace FarrokGames.Inventory.Runtime
{
    public class RepositoryManager : IRepositoryManager
    {
        ...
        public RepositoryManager(IInventoryRepository repository, int width, int height)
        {
        ...
        public bool TryAddAt(IInventoryItem item, Vector2Int point)
        {
            ...
            switch (_repository.InventoryRenderMode)
            {
                ...
                case InventoryRenderMode.Grid:
                    ...
                    break;
                default:
                    Debug.LogError($"InventoryRenderMode.{_repository} is not set. Trying set to Grid");
                    item.position = point;
                    break;
            }
            Rebuild(true);
