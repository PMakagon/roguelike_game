...
namespace FarrokhGames.Inventory
{
    ...
    public class InventoryManagerTests
    {
        ...
        */
        ...
        {
            var inventory = new RepositoryManager(new TestRepository(), 16, 8);
        ...
        */
        ...
        {
            var inventory = new RepositoryManager(new TestRepository(), 4, 4);
        ...
        {
            var inventory = new RepositoryManager(new TestRepository(), 2, 2);
            inventory.TryAdd(CreateFullItem(2, 2));
        ...
        */
        ...
        {
            var inventory = new RepositoryManager(new TestRepository(), 8, 4);
        ...
        */
        ...
        {
            var inventory = new RepositoryManager(new TestRepository(), 3, 3);
            var item = CreateFullItem(3, 3);
            inventory.TryAdd(item);
        ...
        {
            var inventory = new RepositoryManager(new TestRepository(), 1, 1);
            var callbacks = 0;
