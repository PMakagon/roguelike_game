...
namespace FarrokhGames.Inventory.Examples
{
    ...
    public class SizeInventoryExample : MonoBehaviour
    {
        ...
        [SerializeField] private ItemType _allowedItem;
        ...
        void Start()
        {
            var provider = new InventoryRepository(_renderMode,_maximumAlowedItemCount);

            // Create inventory
            var inventory = new RepositoryManager(provider, _width, _height);
            ...
            renderer.RenderInventory(inventory, provider.InventoryRenderMode);
